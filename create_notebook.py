...
# Code: Setup StoryDiffusion Engine
nb.cells.append(nbformat.v4.new_code_cell(
...
# Code: Custom Renderer Node & Graph Compilation
nb.cells.append(nbformat.v4.new_code_cell(
...
with open('d:/ComicBookGenerator/StoryDiffusion_Colab.ipynb', 'w', encoding='utf-8') as f:
    nbformat.write(nb, f)

print("Notebook generated successfully with native graph integration!")
